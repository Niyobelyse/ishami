        ...
        <div>
            <div className="grid grid-cols-2">
                <div className=" inline-flex mt-24">
                    <img src="../image1.png" className="absolute mr-8 rounded-full w-12"/>
                    <img src="../image2.png" className="absolute ml-8 rounded-full w-12"/>
                    <img src="../image3.png" className="absolute ml-16 rounded-full w-12"/>
                </div>
                <div className=" text-2xl font-bold mt-24">13K +</div>
            </div>
            <div><p className=" mt-28">Our app is trusted by many for seamless financial management solutions.</p></div>
        </div>
        <div></div>
      </div>
      <div className=" inline-flex">
